...
* `final-state`
  ...
  * `laser`
    ...
    * `imported_from_file` (`true` if laser pulse is loaded from an external file, `false` if generated by Ptarmigan)
    * `electric_field` (present if imported from file)
    * `a_rms` (present if imported from file)
    * `local_wavelength` (present if imported from file)
    * `phase_step` (present if imported from file)
