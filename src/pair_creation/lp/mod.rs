...
mod tests {
    ...
    fn sum_vs_integral() {
        let pts = [
            ...
            (5.0, 0.1, 7.763605738186e-5),
            (5.0, 0.01, 5.204193377910e-27),
            (7.5, 1.0, 2.292582286148e-1),
            (7.5, 0.1, 7.634180799604e-4),
            (7.5, 0.05, 8.870905077894e-6),
            (10.0, 1.0, 3.250330763466e-1),
            (10.0, 0.1, 2.643473179883e-3),
            (10.0, 0.05, 7.641582086668e-5),
            (15.0, 1.0, 5.045751587513e-1),
            (15.0, 0.1, 1.038498131779e-2),
            (15.0, 0.05, 7.589425540704e-4),
        ];

        for (a, eta, target) in &pts {
            // let (target, _tcdf) = rate_by_summation(*a, *eta);
